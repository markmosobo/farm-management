...
class KienyejiVaccineCostController extends Controller
{
    public function index()
    {
        return KienyejiVaccineCost::latest()->paginate(5);
    }
    ...
    public function store(Request $request)
    {
        ...
        return KienyejiVaccineCost::create([
    ...
    {
        $kienyejivaccinecost = KienyejiVaccineCost::findOrFail($id);
        ...
        $kienyejivaccinecost->update($request->all());
