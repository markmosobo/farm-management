...
class ExoticDrugCostController extends Controller
{
    public function index()
    {
        return ExoticDrugCost::latest()->paginate(5);
    }
    ...
    {
       $exoticdrugcost = ExoticDrugCost::findOrFail($id);
       ...
       $exoticdrugcost->update($request->all());
