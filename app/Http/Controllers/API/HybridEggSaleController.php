...
class HybridEggSaleController extends Controller
{
    public function index()
    {
        return HybridEggSale::latest()->with('poultry')->paginate(5);
    }
    ...
    {
        $hybrideggsale = HybridEggSale::findOrFail($id);
        ...
        $hybrideggsale->update($request->all());
