...
class SubCashWeedingChemicalCostController extends Controller
{
    public function index(){
        return SubCashWeedingChemicalCost::latest()->with('crop')->paginate(5);
    }
    ...
    public function store(Request $request){
        ...
        return SubCashWeedingChemicalCost::create([
    ...
    public function update(Request $request,$id){
        $subcashweedingchemicalcost = SubCashWeedingChemicalCost::findOrFail($id);
        ...
        $subcashweedingchemicalcost->update($request->all());
    ...
    public function destroy(Request $request,$id){
        ...
        $subcashweedingchemicalcost->delete();
