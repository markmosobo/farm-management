...
class ExoticEggSaleController extends Controller
{
    public function index()
    {
        return ExoticEggSale::latest()->with('poultry')->paginate(5);
    }
    ...
    {
        $exoticeggsale = ExoticEggSale::findOrFail($id);
        ...
        $exoticeggsale->update($request->all());
