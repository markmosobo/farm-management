...
class GradeHatchingDetailController extends Controller
{
    public function index()
    {
        return GradeHatchingDetail::latest()->with('poultry')->paginate(5);
    } 
    ...
    public function store(Request $request)
    {
        ...
        return GradeHatchingDetail::create([
    ...
    {
        $gradehatchingdetail = GradeHatchingDetail::findOrFail($id);
        ...
        $gradehatchingdetail->update($request->all());
