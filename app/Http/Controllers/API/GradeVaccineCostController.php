...
class GradeVaccineCostController extends Controller
{
    public function index()
    {
        return GradeVaccineCost::latest()->paginate(5);
    }
    ...
    public function store(Request $request)
    {
        ...
        return GradeVaccineCost::create([
    ...
    {
        $gradevaccinecost = GradeVaccineCost::findOrFail($id);
        ...
        $gradevaccinecost->update($request->all());
