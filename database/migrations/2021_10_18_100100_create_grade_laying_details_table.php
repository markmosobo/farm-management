...
class CreateGradeLayingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('grade_laying_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('grade_laying_details');
    }
}
