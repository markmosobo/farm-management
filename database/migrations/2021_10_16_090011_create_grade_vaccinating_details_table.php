...
class CreateGradeVaccinatingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('grade_vaccinating_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('grade_vaccinating_details');
    }
}
