...
class CreateHybridPoultrySalesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hybrid_poultry_sales', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('hybrid_poultry_sales');
    }
}
