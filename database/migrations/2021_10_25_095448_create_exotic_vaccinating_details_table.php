...
class CreateExoticVaccinatingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('exotic_vaccinating_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('exotic_vaccinating_details');
    }
}
