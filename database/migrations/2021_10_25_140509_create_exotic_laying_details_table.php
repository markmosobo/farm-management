...
class CreateExoticLayingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('exotic_laying_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('exotic_laying_details');
    }
}
