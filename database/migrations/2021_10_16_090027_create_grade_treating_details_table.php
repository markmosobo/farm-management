...
class CreateGradeTreatingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('grade_treating_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('grade_treating_details');
    }
}
