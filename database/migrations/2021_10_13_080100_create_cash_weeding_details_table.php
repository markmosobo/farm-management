...
class CreateCashWeedingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cash_weeding_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('cash_weeding_details');
    }
}
