...
class CreateHybridVaccinatingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hybrid_vaccinating_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('hybrid_vaccinating_details');
    }
}
