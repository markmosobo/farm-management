...
class CreateSubCashPreparingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_cash_preparing_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sub_cash_preparing_details');
    }
}
