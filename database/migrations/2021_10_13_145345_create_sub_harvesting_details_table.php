...
class CreateSubHarvestingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_harvesting_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sub_harvesting_details');
    }
}
