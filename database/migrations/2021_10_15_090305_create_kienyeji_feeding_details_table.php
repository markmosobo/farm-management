...
class CreateKienyejiFeedingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kienyeji_feeding_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('kienyeji_feeding_details');
    }
}
