...
class CreateGradeHatchingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('grade_hatching_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('grade_hatching_details');
    }
}
