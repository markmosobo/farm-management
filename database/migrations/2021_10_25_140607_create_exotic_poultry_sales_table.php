...
class CreateExoticPoultrySalesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('exotic_poultry_sales', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('exotic_poultry_sales');
    }
}
