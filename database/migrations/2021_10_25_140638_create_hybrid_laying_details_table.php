...
class CreateHybridLayingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hybrid_laying_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('hybrid_laying_details');
    }
}
