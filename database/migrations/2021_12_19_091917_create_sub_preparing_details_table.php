...
class CreateSubPreparingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_preparing_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sub_preparing_details');
    }
}
