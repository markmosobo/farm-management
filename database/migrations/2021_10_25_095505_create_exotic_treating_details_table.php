...
class CreateExoticTreatingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('exotic_treating_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('exotic_treating_details');
    }
}
