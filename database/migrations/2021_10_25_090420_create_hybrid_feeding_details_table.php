...
class CreateHybridFeedingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hybrid_feeding_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('hybrid_feeding_details');
    }
}
