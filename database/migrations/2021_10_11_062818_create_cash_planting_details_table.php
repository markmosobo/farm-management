...
class CreateCashPlantingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cash_planting_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('cash_planting_details');
    }
}
