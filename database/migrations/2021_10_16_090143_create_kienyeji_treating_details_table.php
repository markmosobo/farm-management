...
class CreateKienyejiTreatingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kienyeji_treating_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('kienyeji_treating_details');
    }
}
