...
class CreateSubPlantingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_planting_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sub_planting_details');
    }
}
