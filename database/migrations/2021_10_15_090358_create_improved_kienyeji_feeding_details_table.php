...
class CreateImprovedKienyejiFeedingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('improved_kienyeji_feeding_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('improved_kienyeji_feeding_details');
    }
}
