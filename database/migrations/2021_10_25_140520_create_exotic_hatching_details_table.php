...
class CreateExoticHatchingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('exotic_hatching_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('exotic_hatching_details');
    }
}
