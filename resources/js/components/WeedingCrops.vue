                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <td>                                  
                                    ...
                                    /
                                    <a href="#" @click="deletesubWeedingDetail(item.id)">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="card-header">
                            <h3 class="card-title"> Weeding Chemical Costs</h3>
                            <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-primary" @click="subchemicalModal">
                                <i class="fa fa-plus-square"></i>
                                Add New
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr v-for="item in subweedingchemicalcosts.data" :key="item.id">
                                <td>
                                    <span v-if="item.chemical_type == 'ROUNDUP'" class="badge bg-danger">ROUNDUP</span>
                                    <span v-else class="badge bg-primary">{{item.chemical_type | capitalize}}</span>
                                </td>
                                ...
                                <td>                                 
                                    <a href="#" @click="editsubchemicalModal(item)">
                                        <i class="fa fa-edit blue"></i>
                                    </a>
                                    /
                                    <a href="#" @click="deletesubWeedingChemicalCost(item.id)">
                                        <i class="fa fa-trash red"></i>
                                    </a>
                                </td>
                                </tr>
                        ...
                        <!-- Subsistence Chemical Modal -->
                        <div class="modal fade" id="subChemical" tabindex="-1" role="dialog" aria-labelledby="subChemical" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Weeding Chemical Cost</h5>
                                    <h5 class="modal-title" v-show="editmode">Edit Weeding Chemical Cost</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>

                                <form @submit.prevent="editmode ? updatesubWeedingChemicalCost() : createsubWeedingChemicalCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>Name of Chemical</label>  
                                                    ...
                                                    <option value="ROUNDUP">ROUNDUP - RNDP</option>
                                                    </datalist>
                                                    <div v-if="form.errors.has('chemical_type')" v-html="form.errors.get('chemical_type')" />
                                        </div>                                        
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input v-model="form.quantity_bought" type="text" name="quantity_bought" placeholder="approx quantity (e.g 100 grams)"
                        ...
                        <div class="card-footer clearfix">
                            <ul class="pagination pagination-sm m-0 float-right">
                            <pagination :data="subweedingchemicalcosts" @pagination-change-page="getsubWeedingChemicalCosts"></pagination>
                            </ul>
                        </div>
                        </div>
                        <!-- /.card -->                       
                        ...
                        <div class="card collapsed-card">
                        <div class="card-header">
                            <h3 class="card-title"> Weeding Tool Costs</h3>
                            <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-primary" @click="subtoolModal">
                                <i class="fa fa-plus-square"></i>
                                Add New
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr v-for="item in subweedingtoolcosts.data" :key="item.id">
                                <td>
                                    <span v-if="item.tool_type == 'JEMBE'" class="badge bg-danger">JEMBE</span>
                                    <span v-else-if="item.tool_type == 'HOE'" class="badge bg-success">HOE</span>
                                    <span v-else-if="item.tool_type == 'FORKJEMBE'" class="badge bg-info">FORKJEMBE</span>
                                    <span v-else class="badge bg-primary">{{item.tool_type | capitalize}}</span>
                                </td>
                                <td>{{item.quantity_bought}} </td>
                                <td><span class="badge bg-warning">{{item.amount_paid}}</span></td>
                                <td>                                 
                                    <a href="#" @click="editsubtoolModal(item)">
                                        <i class="fa fa-edit blue"></i>
                                    </a>
                                    /
                                    <a href="#" @click="deletesubWeedingToolCost(item.id)">
                                        <i class="fa fa-trash red"></i>
                                    </a>
                                </td>
                                </tr>
                        ...
                        <!-- Subsistence Tool Modal -->
                        <div class="modal fade" id="subTool" tabindex="-1" role="dialog" aria-labelledby="subTool" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Weeding Tool Cost</h5>
                                    <h5 class="modal-title" v-show="editmode">Edit Weeding Tool Cost</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>

                                <form @submit.prevent="editmode ? updatesubWeedingToolCost() : createsubWeedingToolCost()">
                                    <div class="modal-body">                                       
                                        <div class="form-group">
                                            <label>Name of Tool</label>  
                                                    <input type="text" list="tools" v-model="form.tool_type" id="tool_type"
                                                    name="tool_type" class="form-control" :class="{ 'is-invalid': form.errors.has('tool_type') }" />
                                                    <datalist id="tools">
                                                    ...
                                                    <div v-if="form.errors.has('tool_type')" v-html="form.errors.get('tool_type')" />
                                        </div> 
                                        <div class="form-group">
                                            <label>Target Crop</label>
                                            <select class="form-control" :class="{ 'is-invalid': form.errors.has('crop_id') }" v-model="form.crop_id">
                        ...
                        <div class="card-footer clearfix">
                            <ul class="pagination pagination-sm m-0 float-right">
                            <pagination :data="subweedingtoolcosts" @pagination-change-page="getsubWeedingToolCosts"></pagination>
                            </ul>
                        </div>
                        </div>
                        <!-- /.card --> 
                        ...
                        <div class="card collapsed-card">
                        <div class="card-header">
                            <h3 class="card-title">Weeding Labour Costs</h3>
                            <div class="card-tools">
                        ...
                        <div class="card-body p-0">
                            ...
                            <tbody>
                                <tr v-for="item in subweedinglabourcosts.data" :key="item.id">
                                ...
                                <td>                                   
                                    ...
                                    /
                                    <a href="#" @click="deletesubWeedingLabourCost(item.id)">
                                        <i class="fa fa-trash red"></i>
                                    </a>
                                </td>
                                </tr>
                        ...
                        <div class="modal fade" id="subLabour" tabindex="-1" role="dialog" aria-labelledby="subLabour" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Weeding Labour Cost</h5>
                                    <h5 class="modal-title" v-show="editmode">Edit Weeding Labour Cost</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>

                                <form @submit.prevent="editmode ? updatesubWeedingLabourCost() : createsubWeedingLabourCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>Crop</label>
                                            <select class="form-control" :class="{ 'is-invalid': form.errors.has('crop_id') }" v-model="form.crop_id">
                        ...
                        <div class="card-footer clearfix">
                            <ul class="pagination pagination-sm m-0 float-right">
                            <pagination :data="subweedinglabourcosts" @pagination-change-page="getsubWeedingLabourCosts"></pagination>
                            </ul>
                        </div>                                                
                        </div>
                        <!-- /.card --> 
                        ...
                        <div class="card collapsed-card">
                        <div class="card-header">
                            <h3 class="card-title">Other Weeding Costs</h3>
                            <div class="card-tools">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <td>                                    
                                    ...
                                    /
                                    <a href="#" @click="deletesubWeedingOtherCost(item.id)">
                                        <i class="fa fa-trash red"></i>
                                    </a>
                                </td>
                                </tr>
                        ...
                        <div class="modal fade" id="subOtherCost" tabindex="-1" role="dialog" aria-labelledby="subOtherCost" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Weeding Other Cost</h5>
                                    <h5 class="modal-title" v-show="editmode">Edit Weeding Other Cost</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                  ...
                  <div class="tab-pane" id="tab_2">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <td>                                  
                                    ...
                                    /
                                    <a href="#" @click="deletecashWeedingDetail(item.id)">
                                        <i class="fa fa-trash red"></i>
                                    </a>
                                </td>
                                </tr>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="card-header">
                            <h3 class="card-title"> Weeding Chemical Costs</h3>
                            <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-primary" @click="cashchemicalModal">
                                <i class="fa fa-plus-square"></i>
                                Add New
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr v-for="item in cashweedingchemicalcosts.data" :key="item.id">
                                <td>
                                    <span v-if="item.chemical_type == 'ROUNDUP'" class="badge bg-danger">ROUNDUP</span>
                                    <!-- <span v-else-if="item.chemical_type == 'NPK'" class="badge bg-success">NPK</span>
                                    <span v-else-if="item.chemical_type == 'DAP'" class="badge bg-info">DAP</span> -->
                                </td>
                                <td>{{item.quantity_bought}} </td>
                                <td><span class="badge bg-warning">{{item.amount_paid}}</span></td>
                                <td>                                 
                                    <a href="#" @click="editcashchemicalModal(item)">
                                        <i class="fa fa-edit blue"></i>
                                    </a>
                                    /
                                    <a href="#" @click="deletecashWeedingChemicalCost(item.id)">
                                        <i class="fa fa-trash red"></i>
                                    </a>
                                </td>
                                </tr>
                        ...
                        <!-- Cash Chemical Modal -->
                        <div class="modal fade" id="cashChemical" tabindex="-1" role="dialog" aria-labelledby="cashChemical" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Weeding Chemical Cost</h5>
                                ...
                                <form @submit.prevent="editmode ? updatecashWeedingChemicalCost() : createcashWeedingChemicalCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>Name of Chemical</label>  
                                                    <input type="text" list="chemicals" v-model="form.chemical_type" id="chemical_type"
                        ...
                        <div class="card-footer clearfix">
                            <ul class="pagination pagination-sm m-0 float-right">
                            <pagination :data="cashweedingchemicalcosts" @pagination-change-page="getcashWeedingChemicalCosts"></pagination>
                            </ul>
                        </div>
                        </div>
                        <!-- /.card -->                       
                        ...
                        <div class="card-header">
                            <h3 class="card-title"> Weeding Tool Costs</h3>
                            <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-primary" @click="cashtoolModal">
                                <i class="fa fa-plus-square"></i>
                                Add New
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr v-for="item in cashweedingtoolcosts.data" :key="item.id">
                                <td>
                                    <span v-if="item.tool_type == 'JEMBE'" class="badge bg-danger">JEMBE</span>
                                    <span v-else-if="item.tool_type == 'HOE'" class="badge bg-success">HOE</span>
                                    <span v-else-if="item.tool_type == 'FORKJEMBE'" class="badge bg-info">FORKJEMBE</span>
                                ...
                                <td><span class="badge bg-warning">{{item.amount_paid}}</span></td>
                                <td>                                 
                                    <a href="#" @click="editcashtoolModal(item)">
                                        <i class="fa fa-edit blue"></i>
                                    </a>
                                    /
                                    <a href="#" @click="deletecashWeedingToolCost(item.id)">
                                        <i class="fa fa-trash red"></i>
                                    </a>
                                </td>
                                </tr>
                        ...
                        <!-- Cash Tool Modal -->
                        <div class="modal fade" id="cashTool" tabindex="-1" role="dialog" aria-labelledby="cashTool" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Weeding Tool Cost</h5>
                                ...
                                <form @submit.prevent="editmode ? updatecashWeedingToolCost() : createcashWeedingToolCost()">
                                    <div class="modal-body">                                       
                                        <div class="form-group">
                                            <label>Name of Tool</label>  
                                                    <input type="text" list="tools" v-model="form.tool_type" id="tool_type"
                        ...
                        <div class="card-footer clearfix">
                            <ul class="pagination pagination-sm m-0 float-right">
                            <pagination :data="cashweedingtoolcosts" @pagination-change-page="getcashWeedingToolCosts"></pagination>
                            </ul>
                        </div>
                        </div>
                        <!-- /.card --> 
                        ...
                        <div class="card-body p-0">
                            ...
                            <tbody>
                                <tr v-for="item in cashweedinglabourcosts.data" :key="item.id">
                                <td>{{item.date_of_work}}</td>
                                <td>{{item.crop.name}}</td>
                                <td>{{item.no_of_persons}}</td>
                                <td><span class="badge bg-warning">{{item.amount_paid}}</span></td>
                                <td>                                   
                                    ...
                                    /
                                    <a href="#" @click="deletecashWeedingLabourCost(item.id)">
                                        <i class="fa fa-trash red"></i>
                                    </a>
                                </td>
                                </tr>
                        ...
                        <div class="modal fade" id="cashLabour" tabindex="-1" role="dialog" aria-labelledby="cashLabour" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                ...
                                <form @submit.prevent="editmode ? updatecashWeedingLabourCost() : createcashWeedingLabourCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>Crop</label>
                                            <select class="form-control" :class="{ 'is-invalid': form.errors.has('crop_id') }" v-model="form.crop_id">
                        ...
                        <div class="card-footer clearfix">
                            <ul class="pagination pagination-sm m-0 float-right">
                            <pagination :data="cashweedinglabourcosts" @pagination-change-page="getcashWeedingLabourCosts"></pagination>
                            </ul>
                        </div>                                                
                        </div>
                        <!-- /.card --> 
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <td>                                    
                                    ...
                                    /
                                    <a href="#" @click="deletecashWeedingOtherCost(item.id)">
                                        <i class="fa fa-trash red"></i>
                                    </a>
                                </td>
                                </tr>
                  ...
                  <div class="tab-pane" id="tab_3">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <td>                                  
                                    ...
                                    /
                                    <a href="#" @click="deletesubcashWeedingDetail(item.id)">
                                        <i class="fa fa-trash red"></i>
                                    </a>
                                </td>
                                </tr>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="card-header">
                            <h3 class="card-title"> Weeding Chemical Costs</h3>
                            <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-primary" @click="subcashchemicalModal">
                                <i class="fa fa-plus-square"></i>
                                Add New
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr v-for="item in subcashweedingchemicalcosts.data" :key="item.id">
                                <td>
                                    <span v-if="item.chemical_type == 'ROUNDUP'" class="badge bg-danger">ROUNDUP</span>
                                    <span v-else class="badge bg-primary">{{item.chemical_type}}</span>
                                </td>
                                <td>{{item.quantity_bought}} </td>
                                <td><span class="badge bg-warning">{{item.amount_paid}}</span></td>
                                <td>                                 
                                    <a href="#" @click="editsubcashchemicalModal(item)">
                                        <i class="fa fa-edit blue"></i>
                                    </a>
                                    /
                                    <a href="#" @click="deletesubcashWeedingChemicalCost(item.id)">
                                        <i class="fa fa-trash red"></i>
                                    </a>
                                </td>
                                </tr>
                        ...
                        <!-- SubCash Chemical Modal -->
                        <div class="modal fade" id="subcashChemical" tabindex="-1" role="dialog" aria-labelledby="subcashChemical" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Weeding Chemical Cost</h5>
                                ...
                                <form @submit.prevent="editmode ? updatesubcashWeedingChemicalCost() : createsubcashWeedingChemicalCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>Name of Chemical</label>  
                                                    <input type="text" list="chemicals" v-model="form.chemical_type" id="chemical_type"
                        ...
                        <div class="card-footer clearfix">
                            <ul class="pagination pagination-sm m-0 float-right">
                            <pagination :data="subcashweedingchemicalcosts" @pagination-change-page="getsubcashWeedingChemicalCosts"></pagination>
                            </ul>
                        </div>
                        </div>
                        <!-- /.card -->                       
                        ...
                        <div class="card-header">
                            <h3 class="card-title"> Weeding Tool Costs</h3>
                            <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-primary" @click="subcashtoolModal">
                                <i class="fa fa-plus-square"></i>
                                Add New
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr v-for="item in subcashweedingtoolcosts.data" :key="item.id">
                                <td>
                                    <span v-if="item.tool_type == 'JEMBE'" class="badge bg-danger">JEMBE</span>
                                    <span v-else-if="item.tool_type == 'HOE'" class="badge bg-success">HOE</span>
                                    <span v-else-if="item.tool_type == 'FORKJEMBE'" class="badge bg-info">FORKJEMBE</span>
                                ...
                                <td><span class="badge bg-warning">{{item.amount_paid}}</span></td>
                                <td>                                 
                                    <a href="#" @click="editsubcashtoolModal(item)">
                                        <i class="fa fa-edit blue"></i>
                                    </a>
                                    /
                                    <a href="#" @click="deletesubcashWeedingToolCost(item.id)">
                                        <i class="fa fa-trash red"></i>
                                    </a>
                                </td>
                                </tr>
                        ...
                        <!-- SubCash Tool Modal -->
                        <div class="modal fade" id="subcashTool" tabindex="-1" role="dialog" aria-labelledby="subcashTool" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Weeding Tool Cost</h5>
                                ...
                                <form @submit.prevent="editmode ? updatesubcashWeedingToolCost() : createsubcashWeedingToolCost()">
                                    <div class="modal-body">                                       
                                        <div class="form-group">
                                            <label>Name of Tool</label>  
                                                    <input type="text" list="tools" v-model="form.tool_type" id="tool_type"
                        ...
                        <div class="card-footer clearfix">
                            <ul class="pagination pagination-sm m-0 float-right">
                            <pagination :data="subcashweedingtoolcosts" @pagination-change-page="getsubcashWeedingToolCosts"></pagination>
                            </ul>
                        </div>
                        </div>
                        <!-- /.card --> 
                        ...
                        <div class="card-body p-0">
                            ...
                            <tbody>
                                <tr v-for="item in subcashweedinglabourcosts.data" :key="item.id">
                                <td>{{item.date_of_work}}</td>
                                <td>{{item.crop.name}}</td>
                                <td>{{item.no_of_persons}}</td>
                                <td><span class="badge bg-warning">{{item.amount_paid}}</span></td>
                                <td>                                   
                                    ...
                                    /
                                    <a href="#" @click="deletesubcashWeedingLabourCost(item.id)">
                                        <i class="fa fa-trash red"></i>
                                    </a>
                                </td>
                                </tr>
                        ...
                        <div class="modal fade" id="subcashLabour" tabindex="-1" role="dialog" aria-labelledby="subcashLabour" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                ...
                                <form @submit.prevent="editmode ? updatesubcashWeedingLabourCost() : createsubcashWeedingLabourCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>Crop</label>
                                            <select class="form-control" :class="{ 'is-invalid': form.errors.has('crop_id') }" v-model="form.crop_id">
                        ...
                        <div class="card-footer clearfix">
                            <ul class="pagination pagination-sm m-0 float-right">
                            <pagination :data="subcashweedinglabourcosts" @pagination-change-page="getsubcashWeedingLabourCosts"></pagination>
                            </ul>
                        </div>                                                
                        </div>
                        <!-- /.card --> 
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <td>                                    
                                    ...
                                    /
                                    <a href="#" @click="deletesubcashWeedingOtherCost(item.id)">
                                        <i class="fa fa-trash red"></i>
                                    </a>
                                </td>
                                </tr>
