                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Harvesting Costs</h3>
                            <div class="card-tools">
                        ...
                        <div class="modal fade" id="subOtherCost" tabindex="-1" role="dialog" aria-labelledby="subOtherCost" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Harvesting Cost</h5>
                                    <h5 class="modal-title" v-show="editmode">Edit Harvesting Cost</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
