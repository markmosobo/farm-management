                  ...
                  <div class="tab-pane active" id="tab_1">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-primary" @click="subfertilizerModal">
                                <i class="fa fa-plus-square"></i>
                                Add New
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr v-for="item in subplantingfertilizercosts.data" :key="item.id">
                                <td>
                                    <span v-if="item.fertilizer_type == 'FOLIAR'" class="badge bg-danger">FOLIAR</span>
                                    <span v-else-if="item.fertilizer_type == 'NPK'" class="badge bg-success">NPK</span>
                                    <span v-else-if="item.fertilizer_type == 'DAP'" class="badge bg-info">DAP</span>
                        ...
                        <!-- Subsistence Fertilizer Modal -->
                        <div class="modal fade" id="subFertilizer" tabindex="-1" role="dialog" aria-labelledby="subFertilizer" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <form @submit.prevent="editmode ? updatesubPlantingFertilizerCost() : createsubPlantingFertilizerCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                        ...
                        <ul class="pagination pagination-sm m-0 float-right">
                        <pagination :data="subplantingfertilizercosts" @pagination-change-page="getsubPlantingFertilizerCosts"></pagination>
                        </ul>
                        </div>
                        </div>
                        <!-- /.card -->                       
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-primary" @click="subseedModal">
                                <i class="fa fa-plus-square"></i>
                                Add New
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr v-for="item in subplantingseedcosts.data" :key="item.id">
                                <td>
                                    <span v-if="item.seed_type == 'KENYASEED'" class="badge bg">KENYASEED</span>
                                    <span v-else-if="item.seed_type == '614'" class="badge bg">614</span>
                                    <span v-else-if="item.seed_type == '611'" class="badge bg">611</span>
                                    <span v-else-if="item.seed_type == 'SHANGI'" class="badge bg">SHANGI</span>                               
                                </td>
                                <td>{{item.quantity_bought}} </td>
                                <td><span class="badge bg-warning">{{item.amount_paid}}</span></td>
                                <td>                                 
                        ...
                        <!-- Subsistence Seed Modal -->
                        <div class="modal fade" id="subSeed" tabindex="-1" role="dialog" aria-labelledby="subSeed" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <form @submit.prevent="editmode ? updatesubPlantingSeedCost() : createsubPlantingSeedCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Type of Seed</label>  
                                                    ...
                                                    <option class="form-control" value="KENYASEED">Kenya Seed</option>
                        ...
                        <div class="card-footer clearfix">
                        <ul class="pagination pagination-sm m-0 float-right">
                        <pagination :data="subplantingseedcosts" @pagination-change-page="getsubPlantingSeedCosts"></pagination>
                        </ul>
                        </div>
                        </div>
                        <!-- /.card --> 
                        ...
                        <div class="card-body p-0">
                            ...
                            <tbody>
                                <tr v-for="item in subplantinglabourcosts.data" :key="item.id">
                        ...
                        <div class="modal fade" id="subLabour" tabindex="-1" role="dialog" aria-labelledby="subLabour" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                ...
                                <form @submit.prevent="editmode ? updatesubPlantingLabourCost() : createsubPlantingLabourCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>Crop</label>
                                            <select class="form-control" :class="{ 'is-invalid': form.errors.has('crop_id') }" v-model="form.crop_id">
                        ...
                        <div class="card-footer clearfix">
                            <ul class="pagination pagination-sm m-0 float-right">
                        <pagination :data="subplantinglabourcosts" @pagination-change-page="getsubPlantingLabourCosts"></pagination>
                            </ul>
                        </div>                                                
                        </div>
                        <!-- /.card --> 
                  ...
                  <div class="tab-pane" id="tab_2">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="card-header">
                            <h3 class="card-title"> Planting Fertilizer Costs</h3>
                            <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-primary" @click="cashfertilizerModal">
                                <i class="fa fa-plus-square"></i>
                                Add New
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr v-for="item in cashplantingfertilizercosts.data" :key="item.id">
                                <td>
                                    <span v-if="item.fertilizer_type == 'FOLIAR'" class="badge bg-danger">FOLIAR</span>
                                    <span v-else-if="item.fertilizer_type == 'NPK'" class="badge bg-success">NPK</span>
                                    <span v-else-if="item.fertilizer_type == 'DAP'" class="badge bg-info">DAP</span>
                        ...
                        <!-- Cash Fertilizer Modal -->
                        <div class="modal fade" id="cashFertilizer" tabindex="-1" role="dialog" aria-labelledby="cashFertilizer" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Planting Fertilizer Cost</h5>
                                ...
                                <form @submit.prevent="editmode ? updatecashPlantingFertilizerCost() : createcashPlantingFertilizerCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>Type of Fertilizer</label>  
                                                    <input type="text" list="fertilizers" v-model="form.fertilizer_type" id="fertilizer_type"
                        ...
                        <div class="card-footer clearfix">
                            <ul class="pagination pagination-sm m-0 float-right">
                            <pagination :data="cashplantingfertilizercosts" @pagination-change-page="getcashPlantingFertilizerCosts"></pagination>
                            </ul>
                        </div>
                        </div>
                        <!-- /.card -->                       
                        ...
                        <div class="card-header">
                            <h3 class="card-title"> Planting Seed Costs</h3>
                            <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-primary" @click="cashseedModal">
                                <i class="fa fa-plus-square"></i>
                                Add New
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr v-for="item in cashplantingseedcosts.data" :key="item.id">
                                <td>
                        ...
                        <!-- Cash Seed Modal -->
                        <div class="modal fade" id="cashSeed" tabindex="-1" role="dialog" aria-labelledby="cashSeed" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Planting Seed Cost</h5>
                                ...
                                <form @submit.prevent="editmode ? updatecashPlantingSeedCost() : createcashPlantingSeedCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>Crop To Plant</label>
                                            <select class="form-control" :class="{ 'is-invalid': form.errors.has('crop_id') }" v-model="form.crop_id">
                        ...
                        <div class="card-footer clearfix">
                            <ul class="pagination pagination-sm m-0 float-right">
                            <pagination :data="cashplantingseedcosts" @pagination-change-page="getcashPlantingSeedCosts"></pagination>
                            </ul>
                        </div>
                        </div>
                        <!-- /.card --> 
                        ...
                        <div class="card-body p-0">
                            ...
                            <tbody>
                                <tr v-for="item in cashplantinglabourcosts.data" :key="item.id">
                                <td>{{item.date_of_work}}</td>
                                <td>{{item.no_of_persons}}</td>
                                <td><span class="badge bg-warning">{{item.amount_paid}}</span></td>
                                <td>                                   
                        ...
                        <div class="modal fade" id="cashLabour" tabindex="-1" role="dialog" aria-labelledby="cashLabour" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                ...
                                <form @submit.prevent="editmode ? updatecashPlantingLabourCost() : createcashPlantingLabourCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>Crop</label>
                                            <select class="form-control" :class="{ 'is-invalid': form.errors.has('crop_id') }" v-model="form.crop_id">
                        ...
                        <div class="card-footer clearfix">
                            <ul class="pagination pagination-sm m-0 float-right">
                            <pagination :data="cashplantinglabourcosts" @pagination-change-page="getcashPlantingLabourCosts"></pagination>
                            </ul>
                        </div>                                                
                        </div>
                        <!-- /.card --> 
