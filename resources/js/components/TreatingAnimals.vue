                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    ...
                    <div class="col-md-5">
                        <div class="card collapsed-card">
                        <div class="card-header">
                            <h3 class="card-title"> Animal Vaccine Costs</h3>
                            <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-primary" @click="domesticvaccinecostModal">
                                <i class="fa fa-plus-square"></i>
                                Add New
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr v-for="item in domesticvaccinecosts.data" :key="item.id">
                                <td>
                        ...
                        <!-- domestic Vaccine Cost Modal -->
                        <div class="modal fade" id="domesticVaccine" tabindex="-1" role="dialog" aria-labelledby="domesticVaccine" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Animal Vaccine Cost</h5>
                                    <h5 class="modal-title" v-show="editmode">Edit Animal Vaccine Cost</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>

                                <form @submit.prevent="editmode ? updatedomesticVaccineCost() : createdomesticVaccineCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input v-model="form.quantity_bought" type="text" name="quantity_bought" placeholder="approx quantity (e.g 10 mls)"
                        ...
                        <ul class="pagination pagination-sm m-0 float-right">
                        <pagination :data="domesticvaccinecosts" @pagination-change-page="getdomesticVaccineCosts"></pagination>
                        </ul>
                        </div>
                        </div>
                        <!-- /.card -->                       
                        ...
                        <div class="card collapsed-card">
                        <div class="card-header">
                            <h3 class="card-title"> Animal Drug Costs</h3>
                            <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-primary" @click="domesticdrugcostModal">
                                <i class="fa fa-plus-square"></i>
                                Add New
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr v-for="item in domesticdrugcosts.data" :key="item.id">
                                <td>
                        ...
                        <!-- domestic Drug Cost Modal -->
                        <div class="modal fade" id="domesticDrug" tabindex="-1" role="dialog" aria-labelledby="domesticDrug" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Animal Drug Cost</h5>
                                    <h5 class="modal-title" v-show="editmode">Edit Animal Drug Cost</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>

                                <form @submit.prevent="editmode ? updatedomesticDrugCost() : createdomesticDrugCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Quantity</label>
                                            <input v-model="form.quantity_bought" type="text" name="quantity_bought" placeholder="approx quantity (e.g 1 litre,80 grams etc)"
                                                class="form-control" :class="{ 'is-invalid': form.errors.has('quantity_bought') }">
                                                <div v-if="form.errors.has('quantity_bought')" v-html="form.errors.get('quantity_bought')" /> 
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="card-footer clearfix">
                        <ul class="pagination pagination-sm m-0 float-right">
                        <pagination :data="domesticdrugcosts" @pagination-change-page="getdomesticDrugCosts"></pagination>
                        </ul>
                        </div>
                        </div>
                        <!-- /.card --> 
                  ...
                  <div class="tab-pane" id="tab_2">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="card-header">
                            <h3 class="card-title"> Animal Vaccine Costs</h3>
                            <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-primary" @click="petvaccinecostModal">
                                <i class="fa fa-plus-square"></i>
                                Add New
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr v-for="item in petvaccinecosts.data" :key="item.id">
                                <td>
                                    <span class="badge bg">{{item.vaccine_type | capitalize}}</span>
                                </td>
                                <td>{{item.quantity_bought}} </td>
                        ...
                        <!-- pet Vaccine Cost Modal -->
                        <div class="modal fade" id="petVaccine" tabindex="-1" role="dialog" aria-labelledby="petVaccine" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Animal Vaccine Cost</h5>
                                ...
                                <form @submit.prevent="editmode ? updatepetVaccineCost() : createpetVaccineCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>Type of Vaccine</label>  
                                                    <input type="text" list="vaccines" v-model="form.vaccine_type" id="vaccine_type"
                                        ...
                                        <div class="form-group">
                                            <label>Animal to Vaccinate</label>
                                            <select class="form-control" :class="{ 'is-invalid': form.errors.has('animal_id') }" v-model="form.animal_id">
                                            <option value="">Select Animal</option>
                                            <option 
                                                v-for="item in petanimalslist" :key="item.id"
                                        ...
                                        <div class="form-group">
                                            <label>Quantity</label>
                                            <input v-model="form.quantity_bought" type="text" name="quantity_bought" placeholder="approx quantity (e.g 20 mls)"
                                                class="form-control" :class="{ 'is-invalid': form.errors.has('quantity_bought') }">
                                                <div v-if="form.errors.has('quantity_bought')" v-html="form.errors.get('quantity_bought')" /> 
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="card-footer clearfix">
                        <ul class="pagination pagination-sm m-0 float-right">
                        <pagination :data="petvaccinecosts" @pagination-change-page="getpetVaccineCosts"></pagination>
                        </ul>
                        </div>
                        </div>
                        <!-- /.card -->                       
                        ...
                        <div class="card-header">
                            <h3 class="card-title"> Animal Drug Costs</h3>
                            <div class="card-tools">
                            <button type="button" class="btn btn-sm btn-primary" @click="petdrugcostModal">
                                <i class="fa fa-plus-square"></i>
                                Add New
                            </button>
                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                        ...
                        <div class="card-body">
                            ...
                            <tbody>
                                <tr v-for="item in petdrugcosts.data" :key="item.id">
                                <td>
                                    <span class="badge bg">{{item.drug_type | capitalize}}</span>
                                </td>
                                <td>{{item.quantity_bought}} </td>
                        ...
                        <div class="modal fade" id="petDrug" tabindex="-1" role="dialog" aria-labelledby="petDrug" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" v-show="!editmode">Create New Animal Drug Cost</h5>
                                ...
                                <form @submit.prevent="editmode ? updatepetDrugCost() : createpetDrugCost()">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label>Type of Drug</label>  
                                                    <input type="text" list="drugs" v-model="form.drug_type" id="drug_type"
                        ...
                        <div class="card-footer clearfix">
                        <ul class="pagination pagination-sm m-0 float-right">
                        <pagination :data="petdrugcosts" @pagination-change-page="getpetDrugCosts"></pagination>
                        </ul>
                        </div>
                        </div>
                        <!-- /.card --> 
